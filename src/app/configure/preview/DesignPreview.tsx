...
export default function DesignPreview({ configuration }: DesignPreviewProps) {
  ...
  return (
    <>
      ...
      <div className="mt-20 grid grid-cols-1 text:sm sm:grid-colds-12 sm:grid-rows-1 sm:gap-x-6 md:gap-x-8 lg:gap-x-12">
          ...
          <div className="grid grid-cols-1 gap-y-8 border-b border-gray-200 py-8 sm:grid-cols-2 sm:gap-x-6 sm:py-6 md:py-10">
            ...
            <div>
              ...
              <ol className="mt-3 text-zinc-700 list-disc list-inside">
                ...
                <li>Scratch and fingerprint resistan coating</li>
              </ol>
            </div>
          </div>
